...
export default function GitHubProjectCard({ project }: GitHubProjectCardProps) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] border border-gray-100 overflow-hidden h-full">
        <div className="p-6 flex flex-col h-full">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="text-gray-400 group-hover:text-[#6366F1] transition-colors duration-300">
